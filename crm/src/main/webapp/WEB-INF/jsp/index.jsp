		...
		<form action="workbench/index.html" class="form-horizontal" role="form">
			<div class="form-group form-group-lg">
				...
				<div class="checkbox"  style="position: relative;top: 30px; left: 10px;">
					<label>
						<input id="loginTo" type="checkbox"> 十天内免登录
					</label>
				</div>
				<button id="login" type="button" class="btn btn-primary btn-lg btn-block"  style="width: 350px; position: relative;top: 45px;">登录</button>
			</div>
		</form>
	</div>
</div>
