...
list();
	function list(currentPage, rowsPerPage) {
		...
		$("#update").click(function () {
			...
			$.ajax({
				url:"/clue/"+$checkbox.val(),
				type:"get",
				success:function (data) {
							// $("#edit-id").val(data.id),
							// $("#edit-actOwner option[value='"+data.owner+"']").attr("selected","selected");
							// $("#edit-company").val(data.name),
							// $("#edit-call option[value='"+data.appellation+"']").attr("selected","selected");
							// $("#edit-status option[value='"+data.state+"']").attr("selected","selected");
							// $("#edit-surname").val(data.startDate),
							// $("#edit-job").val(data.endDate),
							// $("#edit-email").val(data.cost),
							// $("#edit-phone").val(data.cost),
							// $("#edit-website").val(data.cost),
							// $("#edit-mphone").val(data.description)
							// $("#edit-status").val(data.cost),
							// $("#edit-source").val(data.cost),
							// $("#edit-contactSummary").val(data.cost),
							// $("#edit-describe").val(data.cost),
...
<body>
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select name="owner" owner class="form-control" id="create-clueOwner">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select name="appellation" class="form-control" id="create-call">
									<c:forEach items="${valueList.appellation}" var="v">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select name="state" class="form-control" id="create-status">
									<c:forEach items="${valueList.clueState}" var="v">
										<option value="${v.value}">${v.text}</option>
									</c:forEach>
								</select>
							</div>
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input name="mphone" id="mphone" class="form-control" type="text">
				    </div>
				  </div>
			...
			<div id="page" style="height: 50px; position: relative;top: 60px;">
